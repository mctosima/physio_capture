    ...
    def setup_canvas(self, vp_button=False, slider_control=False):
        ...
        if vp_button:
            collectbutton = button(
                ...
                pos=ver_button_scene.title_anchor,
                bind=vp_collect_stop,
            )
            ver_vpython.cb = collectbutton
            ver_button_scene.append_to_title("  ")
            closebutton = button(
                text='<b style="color:red; font-size:26px">   CLOSE   </b>',
                pos=ver_button_scene.title_anchor,
                bind=vp_closed,
            )
        ...
        if slider_control:
            ...
            slider_text = wtext(
                pos=ver_button_scene.title_anchor, text="10 samples/second"
            )
